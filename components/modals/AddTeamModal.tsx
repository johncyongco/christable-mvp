...
export default function AddTeamModal({ isOpen, onClose, onSave }: AddTeamModalProps) {
  ...
  const zones = ['Zone A', 'Zone B', 'Zone C', 'Zone D', 'Main Hall', 'Entrance', 'Backstage', 'Exhibition Area', 'Outdoor']
  const colors = [
        ...
        <div className="inline-block align-bottom bg-surface-container-lowest rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div className="bg-surface-container-lowest px-6 pt-6 pb-4 sm:p-6 sm:pb-4">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-on-surface">Add New Team</h3>
              <button
                onClick={onClose}
